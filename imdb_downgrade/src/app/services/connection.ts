...
const COUNTRY_PREFIX = `${PREFIX}/api/countries`;
const CITY_PREFIX = `${PREFIX}/api/city`;
...
export const REQUEST_USER_INFO = `${V1_PREFIX}/user/id`;
...
export const REQUEST_ALL_COUNTRIES = `${PREFIX}/api/countries/all`;
...
export const REQUEST_CITIES_BY_COUNTRY = (country: string) => `${CITY_PREFIX}/by-country?country=${country}`;
